...
<body>
	...
	<?php
		...
		echo form_open('gbusnow_controller/providerlogin',$attributes,'class="form-horizontal" id="formLogin"');
		...
		echo "<div class='form-group'>";
			...
			echo form_close();
		echo "</div>";
		echo "Work with US! Sign up <a href='".site_url('gbusnow_controller/providerSignUp')."'>Here!</a>";
