...
<body>
	...
	<?php
		...
		echo form_open('gbusnow_controller/adminLogin',$attributes,'class="form-horizontal" id="formLogin"');
		
		echo "<div class='form-group'>";
			echo "<div class='col-sm-3'>";
				echo form_input('txtadminid', '', 'class="form-control" placeholder="Admin Id"');
			echo "</div>";
